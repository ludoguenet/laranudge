<button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion-{{ $userId }}')">
...
<x-modal name="confirm-user-deletion-{{ $userId }}" :show="$errors->userDeletion->isNotEmpty()" focusable>
    <form method="post" action="{{ route('admin.users.destroy', $user) }}" class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('This user will be permanently deleted.') }}
        </p>
