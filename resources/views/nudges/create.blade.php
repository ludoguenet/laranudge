                            ...
                            <div x-data>
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-auto flex items-center space-x-5">
                                        <div class="flex items-center">
                                            <button @click="parseToHeadingMarkdown()" type="button" class="-m-2.5 inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                                        ...
                                        <div class="flex items-center">
                                            <button @click="parseToBoldMarkdown()" type="button" class="-m-2.5 inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                                        ...
                                        <div class="flex items-center">
                                            <button @click="parseToLinkMarkdown()" type="button" class="-m-2.5 inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                            ...
                            <div x-data="tabs">
                                ...
                                <div class="mt-2">
                                    <div x-show="currentTab === 1" id="tabs-1-panel-1" class="-m-0.5 rounded-lg p-0.5" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                                        ...
                                        <div>
                                            <textarea rows="7" name="code" id="code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6" placeholder="Your PHP snippet goes here!">{{ old('code') }}</textarea>
